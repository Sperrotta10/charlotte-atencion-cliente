...
import { verifyGuest, verifyStaff, verifyAdmin } from '../../middlewares/auth.js';
...
// POST /tables - Crear nueva mesa (PROTEGIDO: Solo Admin)
router.post('/', verifyAdmin, tablesController.createTable);
...
// DELETE /tables/:id - Eliminar Mesa (PROTEGIDO: Solo Admin)
router.delete('/:id', verifyAdmin, tablesController.deleteTable);
